...
with open("destroy.in", "w") as file:
    n = 50000
    m = 100000
    s = 10**18
    file.write(f"{n} {m} {s}\n")
...
public class B_Destroy {
    ...
    private static void antiKruskal() {
        long start = System.nanoTime();// строит остовку максимального веса
        ...
        System.err.println((System.nanoTime() - start)/1000D/1000D/1000D);
    }
